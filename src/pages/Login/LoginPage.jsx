...
import sslBanner from "../../assets/images/payment-banner.png";
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 px-4 gap-3">
      <div className="flex flex-col-reverse md:flex-row items-stretch">
        ...
        {offer && (
          <div className="relative group w-136 min-h-130 rounded-l-2xl shadow border border-gray-200 overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-400 ease-out pointer-events-none">
      ...
      <div className="w-full max-w-4xl">
        <div className="bg-white rounded-2xl shadow border border-gray-200 overflow-hidden">
          {/* Header */}
          <div className="bg-gray-50 border-b border-gray-200 px-3 py-2 flex items-center justify-center gap-2">
            <div className="w-2 h-2 rounded-full bg-green-500" />
            <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">
              Secure Payment Supported By SSLCommerz
            </span>
          </div>
          ...
          <div className=" flex justify-center items-center">
            <img
              ...
              className="w-full max-w-4xl h-3 md:h-6 object-cover"
            />
          </div>
        </div>
      </div>
      ...
      {/* FOOTER */}
      <footer className="w-full max-w-2xl mb-3">
        <div className="flex  items-center justify-center gap-1.5 text-xs text-gray-400">
          {/* <div>
            <span>
              © {new Date().getFullYear()} Krishibid Properties Limited. All
              rights reserved.
            </span>
          </div> */}
          ...
          <div className="flex items-center  gap-4">
            <Link
              to="https://kplbd.com/privacy-policy/"
              target="_blank"
            ...
            <Link
              to="https://kplbd.com/return-refund-policy/"
              target="_blank"
              className="hover:text-[#ebb93a] hover:underline underline-offset-2 transition-colors duration-200"
            >
            ...
            <span className="text-gray-300">·</span>
            <Link
              to="https://kplbd.com/terms-and-conditions/"
              target="_blank"
              className="hover:text-[#ebb93a] hover:underline underline-offset-2 transition-colors duration-200"
            >
              Terms &amp; Conditions
